...
```
bcmp 1.0 64-bit. A reimagined cmp (GNU diffutils).
...
* the *-q*, *--quiet* options suppress informative messages but not error messages sent to *stderr*;
...
In Cygwin the compiled program may be generated as *bcmp.exe*. This must be adjusted in tests.
